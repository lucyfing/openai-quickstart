...
class ArgumentParser:
    def __init__(self):
        self.parser = argparse.ArgumentParser(description='Translate PDF book to target language(default Chinese).')
        ...
        self.parser.add_argument('--target_language', type=str, help='the file is translated to target language')
        self.parser.add_argument('--pages', type=int, help='the file is translated from 1 to pages')
